...
import { TabItem, Tab, styless, icon } from './../../../assets/styles/tab'
...
const TabBar = (props) => {
    ...
    return (
        <>
        <Tab>
            <TouchableWithoutFeedback onPress={() => { props.navigation.navigate('Home') }} style={styless.item}>
                <TabItem>
            ...
            <TouchableWithoutFeedback onPress={() => { props.navigation.navigate('Pesquisar') }} style={styless.item}>
                <TabItem>
            ...
            <TouchableWithoutFeedback onPress={() => { props.navigation.navigate('GerarOrcamento') }} style={styless.add}>
                <TabItem>
                    <CustomIcon name="plus" size={20} style={icon.addBudget} />
                </TabItem>
            </TouchableWithoutFeedback>

            <TouchableWithoutFeedback onPress={() => { props.navigation.navigate('Orcamentos') }} style={styless.item}>
                <TabItem>
            ...
            <TouchableWithoutFeedback onPress={() => { props.navigation.navigate('Perfil') }} style={styless.item}>
                <TabItem>
